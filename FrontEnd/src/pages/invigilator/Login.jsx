      ...
      <div className="w-full h-screen flex flex-row">
        ...
        <div className="w-1/2 bg-blue-600 text-white flex items-center justify-center p-16 overflow-y-auto">
          <div className="max-w-md space-y-8">
            ...
            <div className="text-center space-y-4">
              <h1 className="text-4xl font-bold">Invigilator Portal</h1>
              <p className="text-blue-100 text-lg">
                Access your dashboard to manage duties, track attendance, and request payments.
              </p>
            </div>
        ...
        <div className="w-1/2 flex items-center justify-center p-12 overflow-y-auto bg-white">
          <div className="w-full max-w-md space-y-6">
            <div className="text-center space-y-4">
              <CircularLogo />
              <h2 className="text-3xl font-bold text-gray-900">Invigilator</h2>
            </div>
            ...
            <div className="space-y-3">
              <Link to="/invigilator/register" className="block text-center text-blue-600 hover:text-blue-700 text-sm font-medium">
