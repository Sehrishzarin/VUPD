      ...
      <div className="w-full h-screen flex flex-row">
        ...
        <div className="w-1/2 bg-purple-600 text-white flex items-center justify-center p-16 overflow-y-auto">
          <div className="max-w-md space-y-8">
            ...
            <div className="text-center space-y-4">
              <h1 className="text-4xl font-bold">Register as Superintendent</h1>
              <p className="text-purple-100 text-lg">
                Manage examination centers and oversee invigilation operations with our comprehensive platform
              </p>
            </div>
              
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <Shield className="h-5 w-5 text-white mt-0.5 flex-shrink-0" />
                  <div>
                  <p className="font-semibold">Center Management</p>
                  <p className="text-purple-100 text-sm">Efficiently manage multiple examination centers</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Star className="h-5 w-5 text-white mt-0.5 flex-shrink-0" />
                  <div>
                  <p className="font-semibold">Team Coordination</p>
                  <p className="text-purple-100 text-sm">Coordinate with invigilators seamlessly</p>
                </div>
                  </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="h-5 w-5 text-white mt-0.5 flex-shrink-0" />
                  <div>
                  <p className="font-semibold">Real-time Reports</p>
                  <p className="text-purple-100 text-sm">Access detailed reports and analytics</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="h-5 w-5 text-white mt-0.5 flex-shrink-0" />
                <div>
                  ...
                  <p className="text-purple-100 text-sm">Enterprise-grade security and privacy</p>
                </div>
              </div>
            </div>
        ...
        <div className="w-1/2 flex items-center justify-center p-12 overflow-y-auto bg-white">
          <div className="w-full max-w-md space-y-6">
            <div className="text-center space-y-2">
                <CircularLogo />
              <h2 className="text-3xl font-bold text-gray-900">Superintendent</h2>
              <p className="text-gray-600 text-sm">Enter your credentials to register as a superintendent</p>
            </div>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input placeholder="Superintendent name" className="pl-10" {...field} />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input type="email" placeholder="Superintendent email" className="pl-10" {...field} />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
            ...
            <div className="space-y-3">
              <Link to="/superintendent/login" className="block text-center text-purple-600 hover:text-purple-700 text-sm font-medium">
